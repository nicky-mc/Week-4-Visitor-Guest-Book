...
db.query(`CREATE TABLE IF NOT EXISTS feedback (id SERIAL PRIMARY KEY,visitor_name VARCHAR(70),
    location   VARCHAR(30), favourite_city VARCHAR(30), feedback TEXT NOT NULL); 
    `);

// Insert dummy data
db.query(`INSERT INTO feedback (visitor_name, location, favourite_city, feedback) VALUES
  ...
  ('John Smith', 'London', 'London', 'I love London because I like to risk getting stabbed if I take the wrong turn') ON CONFLICT DO NOTHING;`);
